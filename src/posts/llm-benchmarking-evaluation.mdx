...
image: "/blog/llm-benchmarking-evaluation/cover.svg"
...
graph TD
    ...
    ACC <-->|"High accuracy + low latency = high cost"| PERF
    PERF <-->|"Low cost + low latency = sacrificed accuracy"| COST
    ACC <-->|"High accuracy + low cost = higher latency"| COST
```
...
*Based on DeepLearning.AI's [Fast & Efficient LLM Inference with vLLM](https://www.deeplearning.ai/courses/fast-and-efficient-llm-inference-with-vllm) course (Red Hat, taught by Cedric Clyburn); course material credit to DeepLearning.AI and Red Hat. [GuideLLM](https://github.com/vllm-project/guidellm) and [vLLM](https://github.com/vllm-project/vllm) (vLLM project / Red Hat) and [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) (EleutherAI) are open source.*
