...
export const research = [
  {
    id: 1,
    title: 'Multimodal AI for DNA Sequence and Text Integration',
    venue: 'The Hoarfrost Lab, University of Georgia — 2023–2024',
    authors: ['Vatsal Thakkar', 'The Hoarfrost Lab'],
    desc: 'Multimodal model bridging genomic data and natural language using GPT-4 and Llama-2 for biological function prediction.',
    links: [{ label: 'GitHub', url: 'https://github.com/vatsalthakkar3' }],
  },
  {
    id: 2,
    title: 'Explainability of Text-to-Image Stable Diffusion Models',
    venue: 'University of Georgia — 2023',
    authors: ['Vatsal Thakkar'],
    desc: 'Investigating which image regions are most influenced by individual text tokens using DAAM attention-map analysis.',
    links: [{ label: 'GitHub', url: 'https://github.com/vatsalthakkar3' }],
  },
]
